...
@Component({
  ...
  template: `
    <div
      style="font-family: 'Roboto Condensed'; font-style: normal; font-weight: 700; font-size: 12px;
    ...
    <div
      style="font-family: 'Roboto Condensed'; font-style: normal; font-weight: 400; font-size: 16px;
        line-height: 24px; color: #161722; opacity: 0.78;"
    >
      {{ event?.body }}
    </div>
    <br />
